...
class FlxSound extends FlxBasic
{
	...
	#if (flash || air)
	/**
	 * The Flash/AIR targets have no pitch-shifting audio backend.
	 * This store-only property lets gameplay code compile and run unchanged,
	 * but changes to `pitch` have no audible effect.
	 */
	public var pitch(get, set):Float;
	var _pitch:Float = 1.0;
	inline function get_pitch():Float
